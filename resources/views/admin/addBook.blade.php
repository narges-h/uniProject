...
@section('content')
    ...
    <form
        ...
        @else action="{{ route('insert') }}"  method="POST" @endif
        class="container" {{-- فرم ارسال فایل --}} enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control num" id="price" name="price" value="{{ $book->price }}"
                    required>
            </div>
            <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="rating" name="rating" min="0" max="5"
                    step="0.1" value="{{ $book->rating }}">
            </div>
            <div class="col-md-6">
                <label for="stock" class="form-label">موجودی:</label>
                <input type="number" class="form-control num" id="stock" name="stock" min="0"
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control num" id="number_of_page" name="number_of_page" min="1"
                    value="{{ $book->number_of_page }}" required>
            </div>
            <div class="col-12">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="translator_name" name="translator_name" maxlength="255"
